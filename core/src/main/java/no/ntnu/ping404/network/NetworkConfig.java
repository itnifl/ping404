...
public final class NetworkConfig {
    ...
    public static void resetHeartbeatTimeouts() {
        ...
        no.creekcode.kryonet.core.NetworkConfig.HEARTBEAT_INTERVAL_MS = HEARTBEAT_INTERVAL_MS;
        no.creekcode.kryonet.core.NetworkConfig.HEARTBEAT_TIMEOUT_MS = HEARTBEAT_TIMEOUT_MS;
    }
    ...
    public static void setHeartbeatTimeouts(int intervalMs, int timeoutMs) {
        ...
        no.creekcode.kryonet.core.NetworkConfig.HEARTBEAT_INTERVAL_MS = intervalMs;
        no.creekcode.kryonet.core.NetworkConfig.HEARTBEAT_TIMEOUT_MS = timeoutMs;
    }
}
